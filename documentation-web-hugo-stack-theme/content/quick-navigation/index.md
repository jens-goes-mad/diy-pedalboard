...
The project uses two microcontrollers, the [Arduino Nano](/arduino) for simplicity and the ESP32-S3 for higher 
performance and USB class-compliant connectivity. [Pinouts](/electronics/mcu#pin-out) for both are documented. 
Along the way, I revisited [microcontroller fundamentals](/arduino/avr),
[opcodes and instructions](/arduino/avr/instruction-basics), 
reflecting on [“the good old days”](/design/electronic_circuits). 
